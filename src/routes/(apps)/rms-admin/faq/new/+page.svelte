<!-- /routes/(apps)/rms-admin/faq/new/+page.svelte -->
<script>
...
<div class="space-y-6">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-100">신규 FAQ 등록</h1>
            <p class="text-gray-500 dark:text-gray-400 mt-1">새로운 자주 묻는 질문을 등록합니다.</p>
        </div>
    </div>
