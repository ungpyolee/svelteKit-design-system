            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-xl">
                    ...
                    <section class="p-6">
                        ...
                        <div class="border-2 border-dashed border-gray-200 dark:border-gray-700 rounded-lg p-8 text-center min-h-[300px] flex items-center justify-center">
                            <div class="text-gray-400">
                                <Icon name="FileEdit" size="lg" class="mx-auto mb-2" />
                                <p class="text-sm">Editor.js 에디터 영역</p>
                            </div>
                        </div>
                    </section>
                </div>
